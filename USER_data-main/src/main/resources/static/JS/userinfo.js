...
function fun()
{
    ...
    xhttp.open("GET", "https://backend2k69.herokuapp.com/getallusers", true);
...
function delet()
{
    ...
    xhttp1.open("DELETE", "https://backend2k69.herokuapp.com/deleteuser", true);
...
function updatedata()
{
    ...
    var xhttp = new XMLHttpRequest();
   xhttp.open("PUT", "https://backend2k69.herokuapp.com/update", true);
